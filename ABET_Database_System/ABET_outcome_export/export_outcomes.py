...
API_URL = "Enter Institutions Canvas API url"
API_KEY = "Enter API-key from Canvas account"
...
directory_path = API_function.file_organization(outcome_results_df, '/home/administrator/ABET/ABET_outcome_results/')

directory_path2 = API_function.file_organization(outcome_results_df ,'/home/administrator/ABET/ABET_site/static/images/')
...
#-------------------------------------------------------------------------------------------------
file_path = os.path.join(directory_path, 'outcome_results.csv')
...
#-------------------------------------------------------------------------------------------------  
graphs.bargraph(outcome_results_df_new, directory_path, directory_path2)
graphs.piechart(outcome_results_df_new, directory_path, directory_path2)
graphs.stackedbar_graph(outcome_results_df_new, directory_path, directory_path2)